...
HD_PWD='U:/Users/hawkejo/Documents/Git/vga_controller/vga_controller.runs/vga_pixel_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_pixel_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_pixel_clock.tcl
