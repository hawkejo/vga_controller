...
HD_PWD='U:/Users/hawkejo/Documents/Git/vga_controller/vga_controller.runs/vgaPixelClock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaPixelClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vgaPixelClock.tcl
